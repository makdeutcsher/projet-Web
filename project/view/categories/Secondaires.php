...
?>
        ...
        <div class="vertical-menu">
              ...
              <h2 align="center">Liste Des Ecoles Secondaires </h2></br></br>
...
?>
    ...
    foreach ($fs3 as $f3): ?>
        <tr>
        <th  id=<?= $f3->id_categorie ?>scope="row">
        <?php         
        if (($f3->actif)){
        echo '<a class="lien" href="../../sous-sites/'.$f3->id_categorie.'/'.$i.'/index.php">
        '.$f3->nom.'</a></th>';      
        }else echo $f3->nom.'</th>';
        ?></th>            <td id=<?= $f3->id_categorie ?>><?= $f3->domaine ?></td>
            <td id=<?= $f3->id_categorie ?>><?= $f3->wilaya ?></td>
            <td id=<?= $f3->id_categorie ?>><?= $f3->commune ?></td>
            <td id=<?= $f3->id_categorie ?>><?= $f3->adresse ?></td>
            <td id=<?= $f3->id_categorie ?>><?= $f3->tel ?></td>
            <td id=<?= $f3->id_categorie ?>><?= $f3->fax ?></td>
            <td >Secondaires</td>
...
<?php
           ...
           if(isset($_SESSION['user']) &&  !($_SESSION['admin'])){             
               ...
               echo "<td class=\" .$f3->id_categorie.\"><a class=\"lien\" href=\"../administration/commentaire.php?id_cat=$f3->id_categorie\">Commenter</a></td>";
