...
?>
        ...
        <div class="vertical-menu">
              ...
              <h2 align="center">Liste Des Ecoles Maternelles </h2></br></br>
...
?>
    ...
    foreach ($fs6 as $f6): ?>
    <tr>
    <th  id=<?= $f6->id_categorie ?>scope="row">
        <?php         
        if (($f6->actif)){
        echo '<a class="lien" href="../../sous-sites/'.$f6->id_categorie.'/'.$i.'/index.php">
        '.$f6->nom.'</a></th>';      
        }else echo $f6->nom.'</th>';
        ?></th>        <td id=<?= $f6->id_categorie ?>><?= $f6->domaine ?></td>
        <td id=<?= $f6->id_categorie ?>><?= $f6->wilaya ?></td>
        <td id=<?= $f6->id_categorie ?>><?= $f6->commune ?></td>
        <td id=<?= $f6->id_categorie ?>><?= $f6->adresse ?></td>
        <td id=<?= $f6->id_categorie ?>><?= $f6->tel ?></td>
        <td id=<?= $f6->id_categorie ?>><?= $f6->fax ?></td>
        ...
        <?php
           ...
           if(isset($_SESSION['user']) &&  !($_SESSION['admin'])){             
               ...
               echo "<td class=\" .$f6->id_categorie.\"><a class=\"lien\" href=\"../administration/commentaire.php?id_cat=$f6->id_categorie\">Commenter</a></td>";
