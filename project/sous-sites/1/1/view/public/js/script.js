...
function Supprimer(id) {
    ...
    function change_color_tilte(me){
        console.log($(me).val());

        $("h1").css('color',$(me).val())
        //$(".submit-input").css('color',$(me).val())
        //$(".submit-input").css('background-color',$(me).val())
        
    }
    
    function change_color_background(me){
        console.log($(me).val());

        $("body").css('background-color',$(me).val())
