...
$sql1="SELECT * FROM Type_formation t join Formations f where t.ID=f.ID  and f.id_categorie =1  and  f.nom_ecole='finance_commerce' ";
$sql2="SELECT * FROM Formations f where  f.id_categorie =1 and f.nom_ecole='finance_commerce' ";
