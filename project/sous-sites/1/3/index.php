...
$sql1="SELECT * FROM Type_formation t join Formations f where t.ID=f.ID  and f.id_categorie =1  and  f.id_ecole='3' ";
$sql2="SELECT * FROM Formations f where  f.id_categorie =1 and f.id_ecole='3' ";
...
<script>
    ...
    function initMap() {
        ...
        var uluru = {lat: 36.7050709, lng: 3.1710271};
        // The map, centered at Uluru
        var map = new google.maps.Map(
            document.getElementById('map'), {zoom: 17, center: uluru});//17
